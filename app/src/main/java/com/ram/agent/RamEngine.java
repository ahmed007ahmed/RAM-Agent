...
// المحادثة التفاعلية
if (containsAny(text, "كيف حالك", "كيفك", "اخبارك", "أخبارك")) {
    return "أنا بخير وجاهز للعمل معك. كيف أستطيع مساعدتك الآن؟";
}

if (containsAny(text, "مرحبا", "مرحباً", "السلام عليكم", "اهلا", "أهلا")) {
    return "أهلاً وسهلاً بك، أنا RAM. كيف يمكنني مساعدتك؟";
}

if (containsAny(text, "من انت", "من أنت", "ما اسمك", "اسمك")) {
    return "أنا رام عشيش، موظف ذكي لدى مالكي أحمد عشيش، وهو من قام بإنشائي. وقد سمّاني رام الله عشيش تيمناً باسم ابنه رام الله. أعمل كمساعد لإدارة الأعمال والمهام والعملاء والمتابعات، ويسعدني مساعدتك.";
} 

if (containsAny(text, "شكرا", "شكراً", "مشكور")) {
    return "العفو، أنا جاهز لمساعدتك.";
